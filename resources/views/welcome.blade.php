    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="assets/image/logo.svg" width="200" height="60" alt="" /></a>
                <strong><a href="index.html"><img src="assets/image/flow.png" width="200" height="60" alt="" /></a></strong>
            </div>
