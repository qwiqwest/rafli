    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{ URL('/cashier') }}"><img class="main-logo" src="{{ asset('assets/image/logo.svg') }}" width="200px" height="60px" alt="" /></a>
                <strong><a href="{{ URL('/cashier') }}"><img src="{{ asset('assets/image/flow.png')}}" width="200px" height="60px" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a title="Landing Page" href="{{ URL('/cashier') }}" aria-expanded="false"><span class="fa fa-home icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Home</span></a>
                        </li>
                        <li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="/cashier"><img class="main-logo"height="60px" width="200px" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="{{ URL('/cashier') }}" class="nav-link">Home</a>
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="{{ URL('/cashier') }}">Home</a> <span class="bread-slash">/</span>
                                            </li>
