    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{ URL('/admin') }}"><img class="main-logo" src="assets/image/logo.svg" width="200px" height="60px" alt="" /></a>
                <strong><a href="{{ URL('/admin') }}"><img src="assets/image/flow.png" width="200px" height="60px" alt="" /></a></strong>
            </div>
